...
- 🔭 Сейчас я работаю над продуктом компании [hectaresystems](https://hectaresystems.ru/) и CRM системой для компании [H2O cleaning](https://h2o-cleaner.ru/)

- 🌱 На данный момент учу **styled components, а так же углубляю знания по основным технологиям**

- 💬 Вы всегда можете спросить меня о **TS, react, redux + toolkit, react-leaflet, antd, html & css :D**
